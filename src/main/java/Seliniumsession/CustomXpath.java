...
//x path is not a attribute,
		//address of the webelement in html dom
		//absolute x path will change if we add any new element
		//relative path:
		//xpath: is not an attribute
				...
				//div[@id='content']//form//input[@name='email']////div[@class='col-6 col-md-2']//child::a
				
				//child to parent:
				//backward traversing in xpath: allowed
				//input[@name='email']/../../../../../../../../../..////input[@id='clear']/../../..
				...
				//preceding-sibling:
				//input[@name='email']/preceding-sibling::label[@for='input-email']////select[@name='worklocation']/preceding-sibling::label[@for='worklocation']
				
				//following-sibling:
				//label[@for='input-email']/following-sibling::input[@name='email']////label[@for='hiringmanager']/following-sibling::select[@ng-change='filterduration()'].kmjjj
